...
Future<void> main() async {
  ...
  print(
    'Proxying requests to: https://rpl-notepad-be-production.up.railway.app',
  );
  ...
  await for (final request in server) {
    try {
      ...
      final contentType = proxyRequest.headers.value(
      ...
      request.response.write(
        jsonEncode({'error': 'Proxy error', 'message': e.toString()}),
      );
